...
ssh -o StrictHostKeyChecking=no deploy@178.128.22.245 "cd /var/www && rm -rf ./customer.theclassic.studio/*"

scp -r -o StrictHostKeyChecking=no dist/* deploy@theclassic.studio:/var/www/dev.theclassic.studio
scp -r -o StrictHostKeyChecking=no dist/* deploy@theclassic.studio:/var/www/customer.theclassic.studio
