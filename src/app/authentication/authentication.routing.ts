...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'login', component: PageLoginComponent, data: { title: 'Login :: Lucid Angular', role: 'member' } },
            { path: 'login/staff', component: PageLoginComponent, data: { title: 'Login :: Lucid Angular', role: 'user' } },
            { path: 'register', component: PageRegisterComponent, data: { title: 'Register :: Customer Classic Studio' } },
